            ...
            <form id="editForm" action="${ctx}/system/user?operation=edit" method="post">
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="邮箱" name="email" value="${user.email}" readonly>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" placeholder="出生年月" class="form-control pull-right" name="birthday"
                                   value="<fmt:formatDate value="${user.birthday}" pattern="yyyy-MM-dd"/>" id="datepicker1" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" placeholder="入职时间"  name="joinDate" class="form-control pull-right"
                                   value="<fmt:formatDate value="${user.joinDate}" pattern="yyyy-MM-dd"/>" id="2" readonly>
                        </div>
                    </div>
                </div>
            </form>
