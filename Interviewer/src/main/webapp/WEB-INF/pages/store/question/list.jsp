                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                ...
                                <form action="/store/question?operation=upload" method="post"
                                      enctype="multipart/form-data">
                                    <input type="file" class="form-control" placeholder="上传文件" name="excel">
                                    <input type="submit" value="上传">
                                </form>

                                <button type="button" class="btn btn-default" title="导出题目"
                                        onclick=location.href="${ctx}/store/question?operation=toExport"><i
                        ...
                        <c:forEach items="${page.list}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                                <td><input type="checkbox" name="id" value="${o.id}"/></td>
                                    <%-- <td><img src="${ctx}/upload/${o.picture}"></td>--%>
                                <td>${o.picture}</td>
