                ...
                <c:if test="${module.cType==0}">
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <c:forEach var="modulee" items="${requestScope.modules}">
                                <c:if test="${modulee.cType==1 && modulee.parentId==module.id}">
                                    <li id="${modulee.id}">
                                        <a href="${ctx}/${modulee.curl}" onclick="setSidebarActive(this)" target="iframe">
                                            <i class="fa fa-circle-o"></i>${modulee.name}
                                        </a>
                                    </li>
                                </c:if>
                            </c:forEach>
